...
const ManualAddress = ({route}) => {
  ...
  const {pincode='',city='',state='',houseNo='',buildingNo='',receiverName='',receiverPhone='',petName='',isDefault=false}=route.params.address;
  ...
  const validateForm = () => {
    ...
    if (!formData.receiverPhone) newErrors.receiverPhone = 'Mobile number is required';
    ...
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        <Container style={styles.bottomContainer}>
          ...
          <Button
            title={isSubmitting ? 'Saving...' : 'Update location'}
            buttonStyle={{
              width: normalize(343),
              height: normalize(48),
            }}
